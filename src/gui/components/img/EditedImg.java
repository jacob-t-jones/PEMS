...
public class EditedImg extends Img {
	...
	/*
	 * getSaved - returns "saved", a boolean value indicating whether or not the
	 * image has been saved since the most recent change
	 */
	...
	/*
	 * undo - undoes the most recent change to the image by popping a value from
	 * "currentHistorySequence" and pushing it to "undoneHistorySequence"
	 */
	public void undo() {
	...
	/*
	 * redo - redoes the most recently undone action by popping a value from
	 * "undoneHistorySequence" and pushing it to "currentHistorySequence"
	 */
	public void redo() {
	...
	/*
	 * resizeImage - resizes "image" to the specified size using the
	 * ULTRA_QUALITY setting size - the new size of the image
	 */
	 ...
	 * ULTRA_QUALITY setting width - the new width of the image height - the new
	 * height of the image
	 */
	...
	/*
	 * refreshIcon - calls the parent version of this method, clears
	 * "undoneHistorySequence", adds to "currentHistorySequence", and sets
	 * "saved" to false
	 */
	@Override
