...
public class Img extends JLabel {
	...
	/*
	 * getFilePath - returns "filePath", the full directory path associated with
	 * the image
	 */
	...
	/*
	 * addPadding - adds padding around "image" on all four sides size - the
	 * width of the padding in pixels red - red RGB value for the color of the
	 * padding green - green RGB value for the color of the padding blue - blue
	 * RGB value for the color of the padding
	 */
	...
	/*
	 * cropImage - crops "image" to the specifications of the parameters x - the
	 * x coordinate to begin the crop at y - the y coordinate to begin the crop
	 * at width - the width of the crop height - the height of the crop
	 */
	...
	/*
	 * resizeImage - resizes "image" to the size specified in the parameters,
	 * maintaining its aspect ratio method - the resizing method to utilize size
	...
	/*
	 * resizeImage - resizes "image" to the width and height specified in the
	 * parameters, disregarding aspect ratio method - the resizing method to
	 * utilize width - the new width of the image height - the new height of the
	 * image
	 */
	...
	/*
	 * refreshIcon - reloads the ImageIcon for the label, thus displaying any
	 * new changes to "image"
	 */
	...
	/*
	 * retrieveImage - loads the image located at "filePath" into memory and
	 * returns it * throws InvalidImgException if the file cannot be read
	 */
	...
	/*
	 * retrieveFileExt - returns the file extension from "filePath" * throws
	 * InvalidImgException if the file does not have an extension
	 */
	...
	/*
	 * retrieveFileType - returns the file type from "filePath" * throws
	 * InvalidImgException if the file type is not that of a valid image (jpg or
	 * png)
	 */
