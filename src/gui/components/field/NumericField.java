...
public class NumericField extends JFormattedTextField {
	...
	/*
	 * generateFormatter - returns a NumberFormatter instance that only accepts
	 * positive integer values and allows users to temporarily make invalid
	 * inputs
	 */
	...
	/*
	 * generateFormat - returns an instance of NumberFormat that does not
	 * utilize grouping symbols (commas, periods, etc.)
	 */
