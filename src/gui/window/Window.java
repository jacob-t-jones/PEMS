...
public class Window extends JFrame
{
	...
	/* setBounds - resizes the JFrame using the width and height percentages specified in the parameters, positions it at the center of the screen
	 *     width - the new width of the JFrame
	 * 	  height - the new height of the JFrame
	 */
	...
	/* getManager - returns the instance of FrameManager associated with this JFrame
	 */
