...
public class Thumbnail extends JLabel {
	...
	/*
	 * getFilePath - returns "filePath", the file system path associated with
	 * the Thumbnail
	 */
	...
	/*
	 * getFileName - returns "fileName", the name of the image file associated
	 * with the Thumbnail
	 */
	...
	/*
	 * getFileExt - returns "fileExt", the extension of the image file
