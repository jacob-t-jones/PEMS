...
import gui.display.dialogues.DeleteSelectedDialogue;
import gui.display.dialogues.ResizeDialogue;
...
public class FrameManager 
{
	...
	public FrameManager()
	{
        ...
        this.mainFrame.getContentPane().add(new StartPanel(this));
	 ...
	 */
	public void displayResizeDialogue(EditImgPanel currentScreen, int currentWidth, int currentHeight)
	{
        this.resizeDialogue = new JFrame("Resize Image");
        this.resizeDialogue.getContentPane().add(new ResizeDialogue(this, currentScreen, currentWidth, currentHeight));
	 ...
	 * 		        currentScreen - the instance of ScreenEdit calling this method 
	 */
	public void displayQuitWarningDialogue(EditImgPanel currentScreen)
	{
	 ...
	 * 		          currentScreen - the instance of ScreenEdit calling this method 
	 */
	public void displayRemoveWarningDialogue(EditImgPanel currentScreen)
	{
	 ...
	 * 		          currentScreen - the instance of ScreenEdit calling this method 
	 */
	public void displaySwitchWarningDialogue(EditImgPanel currentScreen)
	{
	 ...
	 * 		            currentScreen - the instance of ScreenEdit calling this method 
	 */
	public void displayContinueWarningDialogue(EditImgPanel currentScreen)
	{
	 ...
	 */
	public void displayDeleteImportsDialogue(SelectPanel currentScreen)
	{
        this.deleteImportsDialogue = new JFrame("Delete Imported Files");
        this.deleteImportsDialogue.getContentPane().add(new DeleteSelectedDialogue(this, currentScreen));
