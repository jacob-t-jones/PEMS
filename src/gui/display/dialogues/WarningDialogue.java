...
public class WarningDialogue extends JPanel implements ActionListener, FocusListener {
	...
	public WarningDialogue(FrameManager manager, PrintPanel currentScreen) {
