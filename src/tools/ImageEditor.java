...
public class ImageEditor {
	...
	/*
	 * addPadding - adds padding around a given image on all four sides image -
	 * the image in question size - the width of the padding in pixels red - red
	...
	/*
	 * brightenImage - brightens the given image by 10% image - the image in
	 * question
	 */
	 ...
	 * image - the image in question x - the x coordinate to begin the crop at y
	...
	/*
	 * darkenImage - darkens the given image by 10% image - the image in
	 * question
	 */
	...
	/*
	 * resizeImage - resizes an image to the size specified in the parameters,
	 * maintaining its aspect ratio image - the image in question size - the new
	 * size of the image
	 */
	...
	/*
	 * resizeImage - resizes an image to the width and height specified in the
	...
	/*
	 * resizeThumbnail - quickly resizes an image to the size specified in the
	 * parameters, maintaining its aspect ratio image - the image in question
	...
	/*
	 * rotateRight90 - rotates an image right by 90 degrees image - the image in
	 * question
	 */
	...
	/*
	 * rotateRight180 - rotates an image right by 180 degrees image - the image
	 * in question
	 */
	...
	/*
	 * rotateRight270 - rotates an image right by 270 degrees image - the image
	 * in question
	 */
	...
	/*
	 * toGrayScale - converts an image to grayscale format image - the image in
	 * question
	 */
